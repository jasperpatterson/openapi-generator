...
public sealed interface BooleanOrLong {
    @JvmInline
    public value class BooleanValue(public val value: kotlin.Boolean) : BooleanOrLong

    @JvmInline
    public value class LongValue(public val value: kotlin.Long) : BooleanOrLong

}

public object BooleanOrLongSerializer : KSerializer<BooleanOrLong> {
