...
public sealed interface UserOrPet {
    @JvmInline
    public value class UserValue(public val value: User) : UserOrPet

    @JvmInline
    public value class PetValue(public val value: Pet) : UserOrPet

}

public object UserOrPetSerializer : KSerializer<UserOrPet> {
