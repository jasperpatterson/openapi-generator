...
internal sealed interface BooleanOrLong {
    @JvmInline
    value class BooleanValue(internal val value: kotlin.Boolean) : BooleanOrLong

    @JvmInline
    value class LongValue(internal val value: kotlin.Long) : BooleanOrLong

}

internal object BooleanOrLongSerializer : KSerializer<BooleanOrLong> {
