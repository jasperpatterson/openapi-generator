...
internal sealed interface UserOrPet {
    @JvmInline
    value class UserValue(internal val value: User) : UserOrPet

    @JvmInline
    value class PetValue(internal val value: Pet) : UserOrPet

}

internal object UserOrPetSerializer : KSerializer<UserOrPet> {
