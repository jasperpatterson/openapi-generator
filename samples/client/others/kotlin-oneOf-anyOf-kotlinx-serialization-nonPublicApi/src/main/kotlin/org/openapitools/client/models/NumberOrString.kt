...
internal sealed interface NumberOrString {
    @JvmInline
    value class BigDecimalValue(internal val value: java.math.BigDecimal) : NumberOrString

    @JvmInline
    value class StringValue(internal val value: kotlin.String) : NumberOrString

}

internal object NumberOrStringSerializer : KSerializer<NumberOrString> {
